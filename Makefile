...
ANALYSES := \
	...
	outputs/results/frequency_effect.yml
...
outputs/results/frequency_effect.yml: outputs/data/processed.csv scripts/03_frequency_effect.R
	$(R_CMD) scripts/03_frequency_effect.R
