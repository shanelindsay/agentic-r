...
ANALYSES := \
	...
	outputs/results/visual_complexity_penalty.yml
...
outputs/results/visual_complexity_penalty.yml: outputs/data/processed.csv scripts/03_visual_complexity_penalty.R
	$(R_CMD) scripts/03_visual_complexity_penalty.R
